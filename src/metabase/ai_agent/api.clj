...
(defn- maybe-inject-collection-id
  "If a tool creates an artifact, lazily ensure the chat sub-collection
   exists and ALWAYS inject its ID — overriding whatever the AI chose.
   This ensures all items land in the correct save location."
